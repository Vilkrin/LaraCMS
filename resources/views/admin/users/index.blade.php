        ...
        <x-slot name="advancedheader">
            ...
            @endif
                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <flux:button href="{{ route('admin.roles.index') }}" icon="plus">Roles & Permissions</flux:button>
                    <!-- Add User Button -->
                ...
                <x-table.cell>
                    <div class="flex items-center space-x-4">
                        ...
                        <form method="POST" action="{{ route('admin.users.destroy', $user->id) }}" onsubmit="return confirm('Are you sure?');">
                            @csrf
                            @method('DELETE')
                            <flux:button class="cursor-pointer" href="{{ route('admin.users.edit', $user->id) }}" icon="trash" variant="danger">Delete</flux:button>                           
                        </form>
                    </div>
                </x-table.cell>
            </x-table.row>
