                    ...
                    <div class="bg-slate-900/50 border border-amber-400/20 backdrop-blur-sm rounded-lg shadow-sm">
                        <div class="p-6">
                            ...
                            <div>
                                ...
                                <flux:button variant="primary" color="amber" class="inline-flex items-center gap-2 px-4 py-2 cursor-pointer" href="{{ route('admin.pages.create') }}" icon="plus">Add Page</flux:button>
                            </div>
