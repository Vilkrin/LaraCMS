    ...
    <body class="text-gray-800 font-inter">
        ...
        <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
            ...
            <ul class="mt-4">
                ...
                <x-admin.side-nav-links href="/" :active="request()->is('/')">Home</x-nav-link>
                <x-admin.side-nav-links href="/about" :active="request()->is('about')">About</x-nav-link>
                <li class="mb-1 group">
          ...
          />
                ...
                <ul class="ml-auto flex items-center">
                    <li class="mr-1 dropdown">
                        <button type="button" class="cursor-pointer dropdown-toggle text-gray-400 mr-4 w-8 h-8 rounded flex items-center justify-center  hover:text-gray-600">
                    ...
                    <li class="dropdown ml-3">
                        <button type="button" class="cursor-pointer dropdown-toggle flex items-center">
