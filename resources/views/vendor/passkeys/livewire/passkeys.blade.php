<div>
    ...
    <div class="mt-2">
        <form id="passkeyForm" wire:submit="validatePasskeyProperties" class="flex items-center space-x-2">
            <div>
                <label for="name" class="block text-sm font-medium text-gray-400">{{ __('passkeys::passkeys.name') }}</label>
            ...
            <button type="submit" class="mt-6 inline-flex justify-center py-2 px-4 font-medium bg-purple-600 hover:bg-purple-700 rounded-md text-sm transition-colors">
