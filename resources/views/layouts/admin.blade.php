        ...
        <aside class="w-64 min-h-screen bg-slate-900/50 border-r border-slate-700">
            ...
            <div class="p-4 border-b border-slate-700">
                <div class="flex items-center gap-2">
                    <svg
                        class="h-8 w-8 text-amber-400 drop-shadow-[0_0_20px_rgba(251,191,36,0.3)]"
                        viewBox="0 0 32 32"
                        fill="none"
                    ...
                    <div>
                        <h2 class="font-orbitron font-bold text-lg bg-linear-to-br from-amber-400 to-amber-500 bg-clip-text text-transparent">
                            LaraCMS
                        </h2>
